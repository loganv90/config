...
vim.keymap.set('n', '<leader>sl', fzf_lua.live_grep_glob, {})
...
vim.keymap.set('n', '<leader>sec', function () fzf_lua.files({ cwd=vim.fn.stdpath('config') }) end, {})
vim.keymap.set('n', '<leader>sep', function () fzf_lua.files({ cwd=vim.fs.joinpath(vim.fn.stdpath('data'), 'lazy') }) end, {})
